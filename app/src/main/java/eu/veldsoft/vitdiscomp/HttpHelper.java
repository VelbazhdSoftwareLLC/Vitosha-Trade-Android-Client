...
class HttpHelper {
	 ...
	 */
	private final String LOAD_RANDOM_ANN_SCRIPT = "json_load_random_ann.php";

	/**
	 * Loading training set for particular ticker and time period.
	 */
	private final String LOAD_TRAINING_SET_SCRIPT = "json_load_training_set.php";

	/**
	 * Report retrained ANN remote server script name.
	 */
	private final String SAVE_RETRAINED_ANN_SCRIPT = "save_retrained_ann.php";
	...
	public boolean load() {
		 ...
		 */
		post = new HttpPost("http://" + url + "/" + LOAD_TRAINING_SET_SCRIPT);
	...
	public boolean store() {
		 ...
		 * Store retrained ANN.
		 */
		HttpPost post = new HttpPost("http://" + url + "/" + SAVE_RETRAINED_ANN_SCRIPT);
		List<NameValuePair> pairs = new ArrayList<NameValuePair>();
